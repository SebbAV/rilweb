<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeEmpleadoGEBuscar.aspx.cs" Inherits="HomeEmpleadoGEBuscar" %>
...
<body onload="Estudio.SelectRegistroEstudio();Usuario.ValidarROL();">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #0092bc; color: white">
                                    <h3><strong>Buscar Estudios</strong></h3>
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="checkbox-inline">
                                            <label>
                                                <input type="checkbox" id="chkEstudios" onchange="Estudio.SelectRegistroEstudio()" />Ver todos
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="button" class="form-control btn-primary" onclick="Estudio.SelectRegistroEstudioFecha();" value="Buscar" />
                                    </div>
                                    <div class="table-responsive">
                                        <table style="width: 100%" class="table table-striped table-bordered table-hover" id="tbl-detalles">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
